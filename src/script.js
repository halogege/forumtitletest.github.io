...
function downloadTwibbon() {
  ...
  twibbonContainer.style.width = '1540px';
  twibbonContainer.style.height = 'auto'; // set height to auto

  domtoimage.toPng(twibbonContainer, {
    width: 1540,
  })
    .then(dataUrl => {
    ...
    .finally(() => {
      twibbonContainer.style.width = '';
      twibbonContainer.style.height = '';
    });
}